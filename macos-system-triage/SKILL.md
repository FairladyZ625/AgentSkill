...
- `kill`, `pkill`, `launchctl kickstart`, `launchctl bootout`, `mdutil -i off`, `mdutil -E`, `spctl`, `xattr -d`, cache deletion, trust database deletion, app uninstall, or anything requiring `sudo`.
